...
using Yna.Engine.Graphics2D.Gui;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Graphics;
using Yna.Engine.Graphics2D.Gui.Widgets;

namespace Yna.Engine.Graphics2D.Scene
{
    /// <summary>
    ...
    public class YnSceneGui : YnScene
    {
        ...
        public override GameObject GetMemberByName(string name)
        {
            GameObject basicEntity = base.GetMemberByName(name);
